  ...
  async (product, thunkAPI) => {
    try {
      const response = await axios.post(
        "https://nest-shop.onrender.com/api/cart/cart-add",
        product
      );
...
export const getCart = createAsyncThunk("cart/getCart", async (_, thunkAPI) => {
  try {
    const response = await axios.get(
      "https://nest-shop.onrender.com/api/cart/"
    );
    return response.data;
  } catch (error) {
    return thunkAPI.rejectWithValue(error.response.data);
  ...
  async (productId, thunkAPI) => {
    try {
      const response = await axios.delete(
        `https://nest-shop.onrender.com/api/cart/${productId}`
      );
      return response.data;
    } catch (error) {
      return thunkAPI.rejectWithValue(error.response.data);
...
export const applyCoupon = createAsyncThunk(
  ...
  async (coupon, thunkAPI) => {
    try {
      const response = await axios.post(
        "https://nest-shop.onrender.com/api/cart/apply-coupon",
        coupon
      );
      return response.data;
    } catch (error) {
...
export const getCoupon = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await axios.get(
        "https://nest-shop.onrender.com/api/coupon/coupon"
      );
      return response.data;
    } catch (error) {
      return thunkAPI.rejectWithValue(error.response.data);
...
export const createOrder = createAsyncThunk(
  ...
  async ({ cartId, shippingAddress }, thunkAPI) => {
    try {
      const response = await axios.post(
        `https://nest-shop.onrender.com/api/order/${cartId}`,
        {
