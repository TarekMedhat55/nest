  ...
  async (user, thunkAPI) => {
    try {
      const response = await axios.post(
        "https://nest-shop.onrender.com/api/auth/register",
        user
      );
...
export const loginUser = createAsyncThunk(
  ...
  async (user, thunkAPI) => {
    try {
      const response = await axios.post(
        "https://nest-shop.onrender.com/api/auth/login",
        user
      );
      return response.data;
    } catch (error) {
...
export const showMe = createAsyncThunk("user/showMe", async (_, thunkAPI) => {
  try {
    const response = await axios.get(
      "https://nest-shop.onrender.com/api/auth/show-me"
    );
    return response.data;
  } catch (error) {
    return thunkAPI.rejectWithValue(error.response.data);
  ...
  async (_, thunkAPI) => {
    try {
      const response = await axios.delete(
        "https://nest-shop.onrender.com/api/auth/logout"
      );
      return response.data;
    } catch (error) {
      return thunkAPI.rejectWithValue(error.response.data);
...
export const forgetUser = createAsyncThunk(
  ...
  async (user, thunkAPI) => {
    try {
      const response = await axios.post(
        "https://nest-shop.onrender.com/api/auth/forget-password",
        user
      );
...
export const resetCodeUser = createAsyncThunk(
  ...
  async (user, thunkAPI) => {
    try {
      const response = await axios.post(
        "https://nest-shop.onrender.com/api/auth/verify-password",
        user
      );
      return response.data;
    } catch (error) {
  ...
  async (user, thunkAPI) => {
    ...
    try {
      const response = await axios.patch(
        "https://nest-shop.onrender.com/api/auth/change-password",
        value
      );
      return response.data;
    } catch (error) {
...
export const getAllAddress = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      const response = await axios.get(
        "https://nest-shop.onrender.com/api/address/"
      );
      return response.data;
    } catch (error) {
      return thunkAPI.rejectWithValue(error.response.data);
...
export const addNewAddress = createAsyncThunk(
  ...
  async (address, thunkAPI) => {
    try {
      const response = await axios.patch(
        "https://nest-shop.onrender.com/api/address/address-add",
        address
      );
      return response.data;
    } catch (error) {
...
export const updateInfo = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    try {
      const response = await axios.patch(
        "https://nest-shop.onrender.com/api/auth/update-name",
        data
      );
      return response.data;
    } catch (error) {
...
export const updateEmail = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    try {
      const response = await axios.patch(
        "https://nest-shop.onrender.com/api/auth/update-email",
        data
      );
      return response.data;
    } catch (error) {
...
export const updatePassword = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    try {
      const response = await axios.patch(
        "https://nest-shop.onrender.com/api/auth/update-password",
        data
      );
      return response.data;
    } catch (error) {
...
export const removeAddress = createAsyncThunk(
  ...
  async (address, thunkAPI) => {
    try {
      const response = await axios.delete(
        `https://nest-shop.onrender.com/api/address/${address}`
      );
      return response.data;
    } catch (error) {
      return thunkAPI.rejectWithValue(error.response.data);
